...
void MyGLWidget::createBuffers ()
{
  ...
  Vertices[6] = glm::vec3(-0.7, 0.5, 0.0);
  Vertices[7] = glm::vec3(0.7, 0.5, 0.0);
  Vertices[8] = glm::vec3(0.0, 1.0, 0.0);
  
  glm::vec3 Vertices2[6];  // Tres vèrtexs amb X, Y i Z
  Vertices2[0] = glm::vec3(-0.7, -0.7, 0.0);
  Vertices2[1] = glm::vec3(-0.7, -0.3, 0.0);
  Vertices2[2] = glm::vec3(0.7, -0.7, 0.0);
  
  Vertices2[3] = glm::vec3(-0.7, -0.3, 0.0);
  Vertices2[4] = glm::vec3(0.7, -0.3, 0.0);
  Vertices2[5] = glm::vec3(0.7, -0.7, 0.0);
