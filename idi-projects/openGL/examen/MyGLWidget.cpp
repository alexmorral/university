...
void MyGLWidget::modelTransformPatricio2 ()
{
  ...
  TG = glm::translate(TG, glm::vec3(0, 2, 0));              //Como escalamos a 2, la mitad del patricio es 1,
  TG = glm::rotate(TG, float(M_PI), glm::vec3(0,0,1));      //el centro del patricio estara en 2 ya que
  TG = glm::scale(TG, glm::vec3(escala, escala, escala));   // es la distancia de centro
  TG = glm::translate(TG, -centrePatr);
...
void MyGLWidget::projectTransform ()
{
  ...
  Proj = glm::perspective(2*valor, 1.0, radiEsc, 3.*radiEsc);
