...
void MyGLWidget::carregaShaders ()
{
  ...
  llumColorLoc = glGetUniformLocation (program->programId(), "colFocus");
  llumLoc = glGetUniformLocation (program->programId(), "posFocus");
}
...
void MyGLWidget::creaIluminacio ()
{
   // glm::vec3 llumPos(xLlum, 0, 2);
    glm::vec3 llumPos(0, 0, 0);
    glUniform3fv(llumLoc, 1, &llumPos[0]);

    glm::vec3 llumCol(0.8, 0.8, 0.8);
    glUniform3fv(llumColorLoc, 1, &llumCol[0]);
